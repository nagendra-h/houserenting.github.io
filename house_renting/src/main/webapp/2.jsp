...
<div class="container">
  ...
  <div class="w3-row w3-padding-64" id="menu">
   <div class="w3-col l6 w3-padding-large">
      <img src="images/house2.jpg" class="w3-round w3-image w3-opacity-min" alt="Menu" style="width:100%">
    </div>
    <div class="w3-col l6 w3-padding-large">
      <h1 class="w3-center">Sai Nandana Apartment</h1><br>
      <h4>Rental Value: ₹14,000</h4>
    
      <h4>Security Deposit: ₹1.0 Lac</h4>
	...
	<form action="https://www.google.co.in/maps/place/Sai+Nandana+Apartment/@12.9080045,77.5094294,17z/data=!3m1!4b1!4m5!3m4!1s0x3bae3f0643a0a117:0x194f2648394db52f!8m2!3d12.9079845!4d77.5119213?hl=en&authuser=0">
